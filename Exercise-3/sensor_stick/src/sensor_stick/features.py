...
def compute_normal_histograms(normal_cloud):
    ...
    # Compute histograms
    ch_1_hist = np.histogram(norm_x_vals, bins=32, range=(0, 256))
    ch_2_hist = np.histogram(norm_y_vals, bins=32, range=(0, 256))
    ch_3_hist = np.histogram(norm_z_vals, bins=32, range=(0, 256))    
